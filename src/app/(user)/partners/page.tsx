...
export default function HomePage() {
  return (
    <main className="min-h-screen">
      <section 
  className="w-full px-4 py-20 md:py-6 flex flex-col md:flex-row items-end gap-0 text-white rounded-[100px] overflow-hidden relative"
        style={{
          position: 'relative',
        }}
      >
        ...
        <div className="md:w-1/2 space-y-6 p-8 w-full pl-0 -ml-12 pt-12 pb-12" style={{ marginTop: '10px' }}>
              <span 
              ...
              <div className="w-[622px]">
                <p 
                  className="font-onest text-[20px] leading-[1.4] text-[#FFFFFF] whitespace-pre-line"
                  style={{
                    fontWeight: 100,
                    letterSpacing: '0%',
                    fontFamily: 'Onest, sans-serif',
            ...
            <div className="absolute top-[4%] left-[55%] z-0 w-[50vw] max-w-[348px]">
  <Image

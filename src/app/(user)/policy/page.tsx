...
export default function PolicyPage() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h1 className="text-3xl font-bold mb-6 bg-white rounded-xl p-6 text-center max-w-prose mx-auto">Оферта и политика конфиденциальности</h1>
            <section className="prose max-w-none">
                {/* Публичная оферта */}
                <h2 className="text-2xl font-semibold mt-6 mb-4 bg-white rounded-xl p-4 text-center max-w-prose mx-auto">Публичная оферта</h2>
                <p className="mb-4">
                ...
                <AccordionSection title="3. Стоимость товара/услуг">
                    ...
                    <p className="mb-2">
                        2.4. Расчеты между Сайтом и Покупателем за товар производятся способами, указанными на Сайте в разделе – <a href={publicUrl.home()} className="text-blue-500 hover:underline">Оплата</a>.
                    </p>
                </AccordionSection>
                ...
                <AccordionSection title="9. Реквизиты Сайта">
                    <p className="mb-2">
                        ИП Атнагулов Р.Р ИНН 025607564994 ОГРН 314745614200022
                                ...
                                <h2 className="text-2xl font-semibold mt-6 mb-4 bg-white rounded-xl p-4 text-center">Политика конфиденциальности</h2>
                <p className="mb-4">

        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="prose max-w-none">
                ...
                <AccordionSection title="6. Доставка товара">
                    ...
                    <p className="mb-2">
                        6.2. Приcurrьерской доставке товара Покупатель в реестре доставки ставит свою подпись напротив тех позиций товара, которые Покупатель приобрел. Данная подпись служит подтверждением того, что Покупатель не имеет претензий к комплектации товара, к количеству и внешнему виду товара.
                    </p>
                    <p className="mb-2">

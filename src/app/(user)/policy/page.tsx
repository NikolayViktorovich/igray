...
export default function PolicyPage() {
    return (
        <div className="container mx-auto px-4 py-8">
            <nav className="mb-6 text-gray-400 text-xs border-t border-gray-200 md:border-t-0 flex items-center gap-1 -mt-6 ml-0 md:ml-11">
                ...
                <span className="text-gray-500">Оферта и политика конфиденциальности</span>
            </nav>
  ...
  Оферта и политика конфиденциальности
            ...
            <section className="prose max-w-none">
                ...
                <p className="mb-4">
                    Использование Сайта означает безоговорочное согласие Пользователя с настоящей Политикой и указанными в ней условиями;<br /> в случае несогласия с этими условиями Пользователь должен воздержаться от использования Сайта.
                </p>

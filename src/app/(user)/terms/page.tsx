...
export default function TermsPage() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h1 className="text-3xl font-bold mb-6 bg-white rounded-xl p-6 text-center max-w-prose mx-auto">Пользовательское соглашение</h1>
            <section className="prose max-w-none">
                ...
                <AccordionSection title="1. Общие положения">
                    ...
                    <p className="mb-2">
                        б) Принимаете все условия настоящего Соглашения в полном объеме без каких-либо изъятий и ограничений с вашей стороны и обязуетес их соблюдать или прекратить использование Сайта. Если вы не согласны с условиями настоящего Соглашения или не имеете права на заключение договора на их основе, вам следует незамедлительно прекратить любое использование Сайта;
                    </p>
                    <p className="mb-2">
                ...
                <AccordionSection title="2. Общие условия пользования Сайтом">
                    ...
                    <p className="mb-2">
                        2.3. Сайт предоставляет Покупателю полную и достоверную информацию о товаре/услугах, включая информацию об основных потребительских свойствах товара, месте изготовления, а также информацию о гарантийном сроке и сроке годности товара на Сайте в карточке товара или иных разделах.
                    </p>
                    <p className="mb-2">
